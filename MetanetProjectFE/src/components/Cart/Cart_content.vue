                          ...
                          <div class="d-flex align-items-center border border-dashed rounded p-3 bg-body">
                            ...
                            <a href="apps/ecommerce/catalog/edit-product.html" class="symbol symbol-50px">
                              <span
                                class="symbol-label"
                                :style="{
                                  'background-image': item.profile
                                    ? 'url(' + item.profile + ')'
                                    : 'url(https://cdn.inflearn.com/public/courses/336001/cover/9368db08-c64b-42ca-8ad1-e7a872bffc0e/336001.jpg?w=736)',
                                }"
                              ></span>
                            </a>
                            <div class="ms-5">
                                ...
                                <thead>
                                  <tr class="text-start text-gray-500 fw-bold fs-7 text-uppercase gs-0">
                                    ...
                                    <th
                                      ...
                                      rowspan="1"
                                      colspan="1"
                                      style="width: 505.729px"
                                      aria-label="Product: activate to sort column ascending"
                                    >
                                      강의
                                    </th>
                                    <th
                                      class="min-w-100px text-end pe-5 sorting"
                                      tabindex="0"
                                      aria-controls="kt_ecommerce_edit_order_product_table"
                                      rowspan="1"
                                      colspan="1"
                                      style="width: 284.698px"
                                      aria-label="Qty Remaining: activate to sort column ascending"
                                    >
                                      예약 가능 인원
                                    </th>
                                  </tr>
                                ...
                                <tr v-for="item in filteredCartItems" :key="item.id" class="odd">
                                  ...
                                  <td>
                                    <div
                                      ...
                                      :data-kt-ecommerce-edit-order-id="'product_' + item.cartId"
                                    >
                                      ...
                                      <div class="ms-5">
                                        ...
                                        <div class="fw-semibold fs-7">
                                          ...
                                          <span data-kt-ecommerce-edit-order-filter="price"
                                            >{{ item.price.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",") }} 원</span
                                          >
                                        </div>
                ...
                <div class="modal fade" id="confirmDeleteModal" tabindex="-1" aria-labelledby="confirmDeleteModalLabel" aria-hidden="true">
                  <div class="modal-dialog">
                    <div class="modal-content">
                      ...
                      <div class="modal-body">정말로 모든 항목을 삭제하시겠습니까?</div>
...
export default {
  ...
  computed: {
    filteredCartItems() {
      ...
      return this.cartData.data.filter(
        (item) => item.title.toLowerCase().includes(query) // 제목에 검색어 포함 여부 확인
      );
    },
  },
  methods: {
