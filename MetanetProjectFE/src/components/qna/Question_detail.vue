<template>
    <div class="container">
        <div class="question">
            <div class="top">
                <div class="top-left">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="#9AA2B8">
                    ...
                    <span class="top-text">{{ response.memberId }}</span>
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="#9AA2B8">
                    ...
                    <span class="top-text">{{ response.lectureTitle }}</span>
