      ...
      <div class="card-body py-3">
        <div class="table-responsive">
          <table class="table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4">
            ...
            <tbody>
              <tr v-for="lecture in myStudyData" :key="lecture.lectureId">
                <td>
                ...
                <td>
                  <span v-if="lecture.startTime && lecture.endTime">
                  ...
                  <div class="d-flex flex-column w-100 me-2">
                    ...
                    <div class="progress h-6px w-100">
                      <div class="progress-bar bg-primary" role="progressbar"
                        ...
                        :aria-valuenow="lecture.attendPercent" aria-valuemin="0" aria-valuemax="100"></div>
                    </div>
                  </div>
                </td>
                <td>
          ...
          <div class="table-responsive">
            <table class="table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4">
              <thead>
                <tr class="fw-bold text-muted">
                  <th></th>
                  <th class="min-w-100px">강의 일련번호</th>
                  <th class="min-w-75px">강의명</th>
                  <th class="min-w-75px">상태</th>
                  <th class="min-w-100px">강의일정</th>
                </tr>
              </thead>
              <tbody>
