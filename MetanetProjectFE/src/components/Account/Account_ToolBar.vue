    ...
    <div class="card-body pt-9 pb-0">
      ...
      <ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bold">
        <li class="nav-item mt-2">
          <a class="nav-link ms-0 me-10 py-5" :class="{ active: activeComponent === 'myStudy' }" href="#" @click.prevent="changeComponent('myStudy')"
            >내 학습률</a
          >
        </li>
        <li class="nav-item mt-2">
          <a
            ...
            :class="{ active: activeComponent === 'myStudyList' }"
            href="#"
            @click.prevent="changeComponent('myStudyList')"
            >내 학습</a
          >
        </li>
        <li class="nav-item mt-2">
          <a class="nav-link ms-0 me-10 py-5" :class="{ active: activeComponent === 'payList' }" href="#" @click.prevent="changeComponent('payList')"
            >결제 내역 조회</a
          >
        </li>
        <li class="nav-item mt-2">
          <a class="nav-link ms-0 me-10 py-5" :class="{ active: activeComponent === 'revenue' }" href="#" @click.prevent="changeComponent('revenue')"
            >매출</a
          >
        </li>
        <li class="nav-item mt-2">
          <a
            class="nav-link ms-0 me-10 py-5"
            :class="{ active: activeComponent === 'myLecture' }"
            href="#"
            @click.prevent="changeComponent('myLecture')"
            >강의</a
          >
        </li>
        <li class="nav-item mt-2">
