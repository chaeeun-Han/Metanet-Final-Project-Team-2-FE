                ...
                <div class="row">
                  ...
                  <div class="col-lg-6 fv-row">
                    <input
                      ...
                      :placeholder="editListData.members.name"
                      v-model="editListData.members.name"
                    />
                  </div>
                  <!--end::Col-->
                </div>
            ...
            <div class="row mb-6">
              ...
              <div class="col-lg-8 fv-row">
                <input
                  ...
                  :placeholder="editListData.members.phone"
                  v-model="editListData.members.phone"
                />
              </div>
              <!--end::Col-->
            </div>
            ...
            <div class="row mb-6">
              ...
              <div class="col-lg-8 fv-row">
                <input
                  ...
                  name="phone"
                  class="form-control form-control-lg form-control-solid"
                  :placeholder="editListData.members.birth"
                  v-model="editListData.members.birth"
                />
              </div>
              <!--end::Col-->
            </div>
            ...
            <div class="row mb-6">
              ...
              <div class="col-lg-8 fv-row">
                <input
                  ...
                  name="phone"
                  class="form-control form-control-lg form-control-solid"
                  :placeholder="editListData.members.attendId"
                  v-model="editListData.members.attendId"
                />
              </div>
              <!--end::Col-->
            </div>
            ...
            <div class="row mb-6">
              ...
              <div class="col-lg-8 fv-row">
                <div class="col-lg-8 fv-row">
                  ...
                  <div
                    class="form-check"
                    v-for="(item, index) in editListData?.category || []"
                    :key="index"
                    style="display: inline-block; margin-right: 15px"
                  >
                    <input type="checkbox" :id="'category-' + index" :value="item" v-model="selectedCategories" class="form-check-input" />
                  ...
                  <p v-else class="text-muted mt-2">현재 관심 분야 : {{ editListData.myCategory.join(", ") }}</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <div class="card-body border-top p-9">
        ...
        <div class="d-flex flex-wrap align-items-center">
          ...
          <div id="kt_signin_email_button" class="ms-auto">
            <button class="btn btn-light btn-active-light-primary" data-bs-toggle="modal" data-bs-target="#emailEditModal">이메일 수정</button>
          </div>
          <!--end::Action-->
        </div>
                ...
                <form id="kt_signin_change_email" class="form">
                  ...
                  <div class="d-flex align-items-center mb-3">
                    ...
                    <button type="button" class="btn btn-primary" @click="senEmailCode" :disabled="loading">
                      ...
                      <span v-else> <span class="spinner-border spinner-border-sm align-middle"></span> 전송 중... </span>
                    </button>
                  </div>
        ...
        <div class="d-flex flex-wrap align-items-center mb-10">
          ...
          <div id="kt_signin_password">
            ...
            <input
              type="password"
              class="form-control border-0 bg-transparent fw-semibold text-gray-600"
              value="{{ editListData.members.password}}"
              readonly
            />
          </div>
          <!--end::Label-->
        ...
        <div class="col-xl-6" data-kt-billing-element="address" v-if="editListData.members.bank">
          ...
          <div class="card card-dashed h-xl-100 flex-row flex-stack flex-wrap p-6">
            ...
            <div class="d-flex align-items-center py-2">
              <button class="btn btn-sm btn-light btn-active-light-primary me-3" data-kt-billing-action="address-delete" @click="deleteBank">
              ...
              <button class="btn btn-sm btn-light btn-active-light-primary" data-bs-toggle="modal" data-bs-target="#pwEditBank">편집</button>
            </div>
            <!--end::Actions-->
          </div>
          <!--end::Address-->
            ...
            <div class="d-flex flex-stack flex-grow-1 flex-wrap flex-md-nowrap">
              ...
              <div class="mb-3 mb-md-0 fw-semibold">
                ...
                <div class="fs-6 text-gray-700 pe-7">
                  본인 명의 계좌만 등록 가능 [타인 계좌 불가] 정확한 계좌 정보를 입력하세요. 오입력 시 정산이 지연될 수 있습니다. 정산 일정 : 매월
                  10일 (주말, 공휴일 제외) 계좌 변경은 정산일 전에 미리 신청해야 합니다. 계좌 정보는 안전하게 보호되며 플랫폼은 계좌 정보를 직업
                  요청하지 않습니다.
                </div>
              </div>
              <div v-if="!editListData.members.bank">
                <button id="kt_password_submit" type="button" class="btn btn-primary me-2 px-6" data-bs-toggle="modal" data-bs-target="#addBankModal">
                  계좌 추가
                </button>
              </div>
              <!--end::Content-->
  ...
  <div class="card">
    ...
    <div id="kt_account_settings_deactivate" class="collapse show">
      ...
      <form id="kt_account_deactivate_form" class="form">
        ...
        <!--begin::Card footer-->
        <div class="card-footer d-flex justify-content-end py-6 px-9">
          <button id="kt_account_deactivate_account_submit" type="submit" class="btn btn-danger fw-semibold" @click="deleteMember">탈퇴하기</button>
        </div>
        <!--end::Card footer-->
      </form>
      <!-- ✅ 누락된 닫는 태그 추가 -->
...
export default {
  ...
  methods: {
    ...
    async getTags() {
      try {
        const tags = await api.get(`/lectures/get-tags`);
        console.log(tags);
      } catch (error) {
